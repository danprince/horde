...
export const javelin_1 = { pivot: { x: 3, y: 1, }, y: 80, url, w: 6, h: 3, x: 0, };
export const javelin_2 = { pivot: { x: 4, y: 0, }, y: 83, url, w: 8, h: 1, x: 0, };
export const javelin_3 = { pivot: { x: 3, y: 1, }, y: 80, url, w: 6, h: 3, x: 6, };
export const javelin_4 = { pivot: { x: 3, y: 3, }, y: 80, url, w: 3, h: 3, x: 12, };
...
export const blood = { y: 64, url, w: 30, h: 5, x: 0, };